             ...
             <div className="flex items-center gap-2" aria-label="Color mode">
                {themeOptions.map(option => (
                     <button
                        ...
                        className="w-10 h-10 rounded-full flex items-center justify-center transition-colors duration-200 border-2 border-transparent hover:border-[var(--md-sys-color-primary)]"
            ...
            <div className="flex flex-col gap-3" aria-label="Accent color">
                {palette.map(hex => (
                  <button
                    ...
                    className="w-8 h-8 rounded-full transition-all duration-200 border-2 border-transparent hover:scale-110 hover:border-[var(--md-sys-color-primary)]"
